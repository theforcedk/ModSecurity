...
checkinstall --maintainer="michael.kjeldsen@vaimo.com" --pkgversion="2.x" --pkgrelease="trusty" --requires="libapr1,libaprutil1,libcurl3-gnutls,libxml2,libpcre3,libc6"